I’ve been excited about JSON-LD, when it came out as it offered a much cleaner way to do SEO. However It dawned on me later that it is also a great format to worked with linked data.
...
3.  JSON-LD uses the `@context` property to map the terms used in the document to URLs, conforming data items to common global, organizational and departmental schemas.

One of the best things about JSON-LD is how easy it is to work with. Developers already familiar with JSON syntax will love using it. And get this: JSON-LD is so popular that it’s now embedded in almost half of all web pages. It’s baffling why all organizations aren’t using JSON-LD more widely to share data between their applications!
...
3.  [ProductOntology](http://www.productontology.org/)
4.  [GoodRelations](http://www.heppnetz.de/projects/goodrelations/)
...
@online{bochman2021,
  ...
  title = {Json-Ld},
  date = {2021-07-01},
  url = {https://orenbochman.github.io/posts/2021/2021-07-01-json-ld/},
  langid = {en}
}
```
...
Bochman, Oren. 2021. “Json-Ld.” July 1. <https://orenbochman.github.io/posts/2021/2021-07-01-json-ld/>.
