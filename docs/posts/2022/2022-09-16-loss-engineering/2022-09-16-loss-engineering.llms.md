...
The `naive` solution is Linear combination. L = \sum {\alpha\_!L_i}
...
- [SemifreddoNets: Partially Frozen Neural Networks for Efficient Computer Vision Systems](href=%22http://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123720188.pdf) / [Video Summary](https://youtu.be/hZWQ2RsF7Fo%22)
...
- [GradNorm: Gradient Normalization for Adaptive Loss Balancing in Deep Multitask Networks](https://arxiv.org/pdf/1711.02257.pdf) an aside: [setting adaptive per weight learning rates](https://www.youtube.com/watch?v=76lj_cKBvmg&list=PLiPvV5TNogxKKwvKb1RKwkq2hm7ZvpHz0&index=44) - implement this this in jax/pytorch etc due to : \Delta w\_{ij}=\epsilon g\_{ij} \frac {\partial E}{\partial w\_{ij}}

- with

  - g\_{ij} is the gain
  - if \frac {\partial E}{\partial w\_{ij}}(t) \cdot \frac {\partial E}{\partial w\_{ij}}(t-1) \>0

- then g\_{ij}(t)=g\_{ij}(t-1)+0.5

else: g\_{ij}(t)=g\_{ij}(t-1)\*.95
...
> **IMPORTANT:**
>
> I used Leo F. Isikdogan’s [Multi-Task Learning Explained in 5 Minutes](https://www.isikdogan.com/blog/multi-task-learning-explained-in-5-minutes.html) as my starting point - as it mentioned the paper that kept coming up
...
Bochman, Oren. 2022. “Loss Engineering and Uncertainty for Multi-Task Learning.” September 12. <https://orenbochman.github.io/posts/2022/2022-09-16-loss-engineering/2022-09-16-loss-engineering.html>.
