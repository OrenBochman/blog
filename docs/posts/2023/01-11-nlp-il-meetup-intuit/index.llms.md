...
![intuit](session0/intuit.png) ![shani gershtein](session0/shani-gershtein.png) ![nlp.il](session0/nlp_il_highlights.png) ![nlp.il at intuit](session0/nlp_il_at_intuit.png) ![nlp.il at intuit](session0/Ido_Farhi.png) ![who we are](session0/who_we_are.png) ![who we serve](session0/who_we_serve.png)

![quickbooks](session0/quickbooks.png) ![credit karma](session0/credit_karma.png) ![mail chimp](session0/mail_chimp.png) ![intuit israel](session0/intuit_israel.png) ![intuit nlp team](session0/intuit_nlp_team.png) ![DS IL](session0/ds_il.png)
...
[![ASR input challenges](session3/Screenshot%20from%202023-03-09%2012-26-34.png)](session3/Screenshot%20from%202023-03-09%2012-26-34.png "ASR input challenges")
...
[![Augmentations](session3/Screenshot%20from%202023-03-09%2012-43-37.png)](session3/Screenshot%20from%202023-03-09%2012-43-37.png "Augmentations")
...
[![ASR challenges](session3/Screenshot%20from%202023-03-09%2012-45-14.png)](session3/Screenshot%20from%202023-03-09%2012-45-14.png "ASR challenges")

ASR challenges

[![diversity challenge](session3/Screenshot%20from%202023-03-09%2012-46-00.png)](session3/Screenshot%20from%202023-03-09%2012-46-00.png "diversity challenge")
...
[![what’s next](session3/Screenshot%20from%202023-03-09%2012-47-57.png)](session3/Screenshot%20from%202023-03-09%2012-47-57.png "what’s next")
