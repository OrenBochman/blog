...
Stumpy ([Law 2019](#ref-law2019stumpy)) is a powerful and scalable library for computing a matrix profile which can be used for a variety of time series data mining tasks.

This post is based on ([Law 2021](#ref-sean2021online))
...
- ([Yeh et al. 2016](#ref-Yeh2016MatrixProfileI))
...
Law, Sean M. 2021. *Modern Time Series Analysis with STUMPY*. [Https://youtu.be/XKNdXN-Jfmo](https://youtu.be/XKNdXN-Jfmo).

Yeh, Chin-Chia Michael, Yan Zhu, Liudmila Ulanova, et al. 2016. “Matrix Profile i: All Pairs Similarity Joins for Time Series: A Unifying View That Includes Motifs, Discords and Shapelets.” *2016 IEEE 16th International Conference on Data Mining (ICDM)*, 1317–22. <https://doi.org/10.1109/ICDM.2016.0179>.
...
Bochman, Oren. 2024. “Stumpy.” August 8. <https://orenbochman.github.io/posts/2024/2024-08-08-TS-with-Stumpy/>.
