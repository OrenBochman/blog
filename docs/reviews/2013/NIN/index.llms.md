...
In ([Lin et al. 2014](#ref-lin2014networknetwork)) the authors, Lin, Min, Qiang Chen, and Shuicheng Yan, of this paper titled “Network in Network” paper came up with a way of connencting somee ideas on improving CNNs which had been mostly getting bigger (VGG \> AlexNet \> LeNet) . They replaced traditional linear filters in convolutional neural networks (CNNs) with multilayer perceptrons (MLPs) to enhance local feature abstraction. This new architecture, called NIN, also introduces **global average pooling** in place of *fully connected layers* thus reducing overfitting, improving model interpretability and more significantly reducing the size of the network.
...
[![Cifar-10 error rates](./results.png)](./results.png "Cifar-10 error rates")

Cifar-10 error rates
...
[![Visulization](./fig4.png)](./fig4.png "Visulization")
...
Lin, Min, Qiang Chen, and Shuicheng Yan. 2014. *Network in Network*. <https://arxiv.org/abs/1312.4400>.
...
Bochman, Oren. 2018. “NIN --- Network in Network.” December 31. <https://orenbochman.github.io/reviews/2013/NIN/>.
