**Sense2Vec** ([Trask et al. 2015](#ref-trask2015sense2vecfastaccurate)) is an interesting deep learning model based on word2vec that can learn more interesting and detailed word vectors from large corpora. Sense2Vec embeddings are for word senses rather than for tokens.
...
Trask, Andrew, Phil Michalak, and John Liu. 2015. *Sense2vec - a Fast and Accurate Method for Word Sense Disambiguation in Neural Word Embeddings*. <https://arxiv.org/abs/1511.06388>.
...
Bochman, Oren. 2022. “Sense2vec - A Fast and Accurate Method for Word Sense Disambiguation In Neural Word Embeddings.” June 26. <https://orenbochman.github.io/reviews/2015/sense2vec/>.
