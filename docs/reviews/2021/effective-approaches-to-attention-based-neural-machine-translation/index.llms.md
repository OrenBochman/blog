[![deeplearning.ai](logo_deeplearning.ai.png)](logo_deeplearning.ai.png "deeplearning.ai")
...
[![rnn](paper-eata-01-nmt.png)](paper-eata-01-nmt.png "rnn")
...
|:--:|:--:|
| ![Global Attention](paper-eata-02-attention-global.png) | ![Local Attention](paper-eata-03-attention-local.png) |

They also came up with a interesting way to visualize the alignment’s attention mechanism.

[![alignment-visulization](c4w2-22-alignment-visulization.png)](c4w2-22-alignment-visulization.png "alignment-visulization")
...
[![page 1](page-001.png)](page-001.png "page 1")
...
[![page 2](page-002.png)](page-002.png "page 2")
...
log \space p(y \vert x) = \sum\_{j=1}^m log \space p (y_j \vert y\_{\<j} , s)
...
J_t=\sum\_{(x,y)\in D} -log \space p(x \vert y)
...
[![page 3](page-003.png)](page-003.png "page 3")
...
![page 4](page-004.png) in §3.2 they consider a local attention mechanism. This is a resource saving modification of global attention using the simple concept of applying the mechanism within a fixed sized window.
...
[![page 5](page-005.png)](page-005.png "page 5")
...
[![page 6](page-006.png)](page-006.png "page 6")

page 6

------------------------------------------------------------------------

[![page 7](page-007.png)](page-007.png "page 7")

page 7

------------------------------------------------------------------------

![page 8](page-008.png) In §5.4 In alignment quality

------------------------------------------------------------------------

[![page 9](page-009.png)](page-009.png "page 9")
...
![page 10](page-010.png) the references

------------------------------------------------------------------------

![page 11](page-011.png) This is appendix A which shows the visualization of alignment weights.
...
@online{bochman2021,
  ...
  date = {2021-03-21},
  url = {https://orenbochman.github.io/reviews/2021/effective-approaches-to-attention-based-neural-machine-translation/},
  langid = {en}
}
```
...
Bochman, Oren. 2021. “Effective Approaches to Attention-Based NMT.” March 21. <https://orenbochman.github.io/reviews/2021/effective-approaches-to-attention-based-neural-machine-translation/>.
