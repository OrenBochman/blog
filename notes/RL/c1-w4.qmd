...
\State Initialize $V(s)$ arbitrarily,  $\forall s \in S$, and V (terminal) to 0
\REPEAT
...
$$
\pi_0 \xrightarrow{\text{Policy Evaluation}} v_{\pi_0} \xrightarrow{\text{Policy Improvement}} \pi_1 \xrightarrow{\text{Policy Evaluation}} v_{\pi_1} \xrightarrow{\text{Policy Improvement}} \ldots \pi_* \xrightarrow{\text{Policy Evaluation}} v_{\pi_*}
$$
...
optimal policy for a given MDP. The algorithm starts with an initial estimate 
of the value function and iteratively updates the value function until it 
