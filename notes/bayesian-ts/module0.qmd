...
- There is a issues with mathematics most of the results and techniques are so rarely useful that students will soon forget most but a few very useful results. Having a good memory is a great asset in mathematics but is rarely enough. I like to review some mathematical results from my undergraduate days evey five years or so. This helps me keep many of the results fresh in my mind and also makes reading new mathematics easier. Fundamentals in mathematics can fo a very long way.
This is material from topology, determinants and solving linear equations, numerical methods for decomposing matrices, and so on. Definions of certain groups. 
...
A five step process for identifying, selecting and assessing ARMA
(and similar) models.
...
![Bayesian Modeling and Computation in Python](BMCP2021.jpg){.column-margin width="150px"}
...
![Bayesian Inference for Stochastic Processes by Lyle D. Broemeling](broemeling2018bayesian.jpg){.column-margin width="150px" style="vertical-align: top;" }
...
### Statistics for Spatio-Temporal Data
 ...
 ![Statistics for Spatio-Temporal Data](cressie2011statistics.jpg){.column-margin width="150px" style="vertical-align: top;" }
...
![Bayesian Analysis of Stochastic Process Models](rios2012bayesian.jpg){.column-margin width="150px" style="vertical-align: top;" }
