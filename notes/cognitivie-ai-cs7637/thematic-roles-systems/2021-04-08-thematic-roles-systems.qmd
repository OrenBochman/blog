...
date: 2021-04-08
draft: true
categories: [notes, KB-AI, modelling, AI]
...
Thematic roles are semantic labels for representing sentences as frames based on the verb and its complements. They allow us to understand that a sentences
...
Note that these theta roles are semantic categories. we will Grammar and the lexicon impose further restrictions on roles 


![Aspects Grammar Model](https://upload.wikimedia.org/wikipedia/commons/8/86/Aspects_Grammar_Model.jpg)
<!--
{% include figure.html 
...
They are constraints on the syntactical production rules which restrict the a generative grammar to exclude ungrammatical sentences. see - [@ouhalla1999introducing §3.2] these are defined as:
...
However subcategorization restriction are not sufficient to ensure a generative grammar produces only grammatical sentences.

### Selectional restrictions 

c.f. §3.3 in [Introducing Transformational Grammar]

For verbs and other categories on features like 
$\lbrace \pm abstract \rbrace$ or $ \lbrace \pm animate \rbrace$

## The big picture

![](KBAI-thematic-roles.svg)
...
some verbs can be put into Alternation.
