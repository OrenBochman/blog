...
- In **supervised ML** we get dataframe with input features $X$ and thier corresponding ground truth label $Y$.
...
## Sigmoid {#sec-sigmoid}
We should start by developing intuition about how the cost function is designed the way it is. This is **important** because you will meet the `sigmoid` in *Neural Networks*, *job interviews* and so best make a friend of it. In[@GefforyHinton2012MOOC] there is the full derivation of Sigmoid cost function. Also the sigmoid and Logistic regression are intimtely relatted - you can't have one without the other.
:::
...
First cakcukate derivatüe Of Sigmoid function (it be useful while finding partial derivative Of 
Note that We computed the partial derivative Of the Sigmoid funttiM_ If We Were to derive , 9) with respect to $O_j$, you would get — 
...
- [derivative of cost function for Logistic Regression](https://math.stackexchange.com/questions/477207/derivative-of-cost-function-for-logistic-regression) Congrtulations. You now know the full derivation Of logistic regression! 
