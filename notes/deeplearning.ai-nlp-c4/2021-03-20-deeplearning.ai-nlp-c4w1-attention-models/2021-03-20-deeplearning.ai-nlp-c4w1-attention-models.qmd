...
![screenshot_of_outline_slide](c4w1_screenshot_01.png)
...
![encoder decoder architecture](c4w1_screenshot_03.png)
...
![screenshot_of_outline_slide](c4w1_screenshot_10.png)
...
![recall in ROUGE](c4w1_screenshot_11.png)
...
![precision in ROUGE](c4w1_screenshot_12.png)
...
~~~
## Beam Search
The [beam search](https://en.wikipedia.org/wiki/Beam_search) algorithm is a  limited (best-first search). The parameter for the beam width limits the choices considered at each step. ![Beam Search](c4w1_screenshot_15.png)
