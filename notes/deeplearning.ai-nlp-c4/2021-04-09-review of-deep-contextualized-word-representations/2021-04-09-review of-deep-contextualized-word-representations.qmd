...
|:---:|:---:|
|![](paper-eata-02-attention-global.png)|![](paper-eata-03-attention-local.png)|
</center>
They also came up with a interesting way to visualize the alignment's attention mechanism.
![alignment-visulization](c4w2-22-alignment-visulization.png)
<hr>
...
<hr>
![page 10](page-010.png)
the references
<hr>
![page 11](page-011.png)
