...
![question-answering](V1-002-question-answering.png)
...
![classical-training](V1-004-classical-training.png)
<hr>

![transfer-learning](V1-005-transfer-learning.png)
<hr>

![transfer-learning-tasks](V1-006-transfer-learning-tasks.png)
...
![transfer-learning-options](V2-010-transfer-learning-options.png)
...
- fine tuning
<hr>
![tl-general-purpose](V2-011-tl-general-purpose.png)
<hr>
![tl-features-vs-fine-tuning](V2-012-tl-features-vs-fine-tuning.png)
...
<hr>
![tl-fine-tuning](V2-013-tl-fine-tuning.png)
 
<hr>

![tl-pretain-data-performance](V2-014-tl-pretain-data-performance.png)
<hr>

![tl-pretain-data-supervision](V2-015-tl-pretain-data-supervision.png)
<hr>

![tl-pretain-unsupervised](V2-016-tl-pretain-unsupervised.png)
<hr>

![tl-pretrain-selfsupervised](V2-017-tl-pretrain-selfsupervised.png)
<hr>

![tl-pretrain-selfsupervised](V2-018-tl-pretrain-selfsupervised.png)
<hr>
![tl-per-task-fine-tuning](V2-019-tl-per-task-fine-tuning.png)
...
<hr>
![tl-summary](V2-020-tl-summary.png)
<hr>
...
![outline](V3-030-outline.png)
<hr>

![CBOW-fixed-window](V3-031-CBOW-fixed-window.png)
## CBOW
...
![CBOW-issues](V3-032-cbow-issues.png)
<hr>

![ELMo-solution](V3-033-elmo-solution.png)
so what do we do when we need more context to model the concept we are looking at?
<hr>

![ELMo-RNN](V3-034-elmo-rnn.png)
...
<hr>
![GPT-unidirectional](V3-035-GPT-unidirectional.png)
...
![BERT](V3-036-bert.png)
BERT was then introduced which stands for the Bi-directional Encoder Representation from Transformers.

<hr>

![multi-mask](V3-037-multi-mask.png)
<hr>

![BERT-pre-training](V3-038-BERT-pre-training.png)
<hr>

![t5-encoder-decoder](V3-039-t5-encoder-decoder.png)
...
i.
<hr>
![BERT-question](V4-050-bert-question.png)
<hr>
![BERT-summary](V4-050-bert-summary.png)
Training procedures:
...
<hr>
![BERT](V4-051-bert.png)
<hr>
![BERT-spec](V4-052-bert-spec.png)
 
 Spec and features:
<hr>

![BERT-pre-training](V4-053-bert-pre-training.png)
<hr>
## Video 5 : BERT Objective

![BERT-outline](V5-060-BERT-outline.png)
...
![BERT-the-input](V5-061-BERT-the-input.png)
...
![BERT-the-output](V5-062-BERT-the-output.png)
...
<hr>
![BERT-objectives](V5-063-BERT-objectives.png)
The BERT objective is defined as follows: 
<hr>

![BERT-summary](V5-064-BERT-summary.png)
<hr>
## Video 6: Fine tuning BERT

![BERT-fine-tuning-outline](V6-070-BERT-fine-tuning-outline.png)
Once you have a pre-trained model, you can fine tune it on different tasks. 
<hr>
![inputs](V6-071-inputs.png)
...
![summary](V6-072-summary.png)
<hr>

## Video 7: Transformer: T5
![t5-outline](V7-073-t5-outline.png)
One of the major techniques that allowed the T5 model to reach state of the art is the concept of masking:

<hr>

![t5-text-to-text](V7-074-t5-text-to-text.png)
<hr>

![T5-transformer](V7-075-T5-transformer.png)
...
![T5-architecture](V7-076-T5-architecture.png)
...
![T5-architecture](V8-080-T5-architecture.png)
<hr>

![T5-summary](V8-081-T5-summary.png)
<hr>

![T5-multi-task-training](V8-082-T5-multi-task-training.png)
...
![io-format](V8-083-io-format.png)
<hr>

![multi-task-training](V8-084-multi-task-training.png)
<hr>

![data-training-strategy](V8-085-data-training-strategy.png)
<hr>

![unfreezing-adapter-layers](V8-086-unfreezing-adapter-layers.png)
<hr>

![question](V8-087-question.png)
<hr>

![fine-tuning](V8-088-fine-tuning.png)
...
![GLUE-evaluation](V9-090-GLUE-evaluation.png)
...
![GLUE-tasks](V9-091-GLUE-tasks.png)
<hr>

![GLUE](V9-092-GLUE.png)
<hr>

## Video 10:Question Answering

![BERT-feed-forward-block](V9-093-BERT-feed-forward-block.png)
You will be implementing an encoder this week. Last week you implemented the decoder. So here it is: 
<hr>

![BERT-encoder-Block](V9-094-BERT-encoder-Block.png)
<hr>

![BERT-blocks](V9-095-BERT-blocks.png)
...
<hr>
![q&a-data-example](V9-096-q&a-data-example.png)

<hr>

![q&a-with-t5](V9-097-q&a-with-t5.png)
<hr>

![t5](V9-098-t5.png)
<hr>

![t5-question](V9-099-t5-question.png)
<hr>
