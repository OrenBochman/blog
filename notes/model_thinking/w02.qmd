...
categories: ["model thinking", "sorting", "peer effects", "segregation", "homophily", "Schelling's Segregation Model", "Index of Dissimilarity", "Granovettor's Threshold Model", "Standing Ovation Model", "the Identification Problem", "Agent-Based Modelling" ]
from: markdown+emoji
draft: false
---
...
![New York - ethnical coded](images/mt_ny_ethnic_coding.jpg){.column-margin}
...
#| tbl-cap: Segregation in US cities with a population > 20k based on the 2020 census 
