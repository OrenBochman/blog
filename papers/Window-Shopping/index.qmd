...
This unpublished paper considers the **free riding** problem by customers who go to a store and 
try the product's fit and or consult with staff but then buy it from the cheapest online store.

A couple of notes on the paper titled Window-Shopping"
format: html from https://dx.doi.org/10.2139/ssrn.2374720 by Shy Oz
...
7. Retailers (like Zara) may also only unique lines of items so that the buyer cannot get the same item elsewhere. Buy limiting the time these lines are available they can also create a sense of urgency in the buyer.
