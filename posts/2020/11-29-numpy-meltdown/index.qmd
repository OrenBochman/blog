...
subtitle: numpy and scipy break on macos
description: "Just a rant at `numpy` and `scipy` breaking when I really needed them."
categories: [python, macos, bugs]
image: literature-review-highlights.jpg
