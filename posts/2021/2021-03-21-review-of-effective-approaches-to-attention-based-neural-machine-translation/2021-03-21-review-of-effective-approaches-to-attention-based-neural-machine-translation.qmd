...
date-modified:  2021-04-07
title: Effective Approaches to Attention-based NMT
subtitle: Paper review for the deeplearning.ai NLP specialization
description: Review of the paper on dot product attention for the deeplearning.ai NLP specialization.
categories: [nlp, coursera, notes, paper, attention, deep learning, literature review]
image: literature-review-open-book.jpg
---
<style>
hr { 	clear:both;  }
...
![deeplearning.ai](logo_deeplearning.ai.png){.logo .column-margin}
...
![rnn](paper-eata-01-nmt.png){.column-margin}
...
![alignment-visulization](c4w2-22-alignment-visulization.png){.hi}
...
![page 1](page-001.png){.column-margin}
...
![page 2](page-002.png){.column-margin}
...
![page 3](page-003.png){.column-margin}
...
![page 4](page-004.png){.column-margin}
...
![page 5](page-005.png){.column-margin}
...
![page 6](page-006.png){.column-margin}


---


![page 7](page-007.png){.column-margin}


---


![page 8](page-008.png){.column-margin}
...
![page 9](page-009.png){.column-margin}
...
![page 10](page-010.png){.column-margin}
the references
...
![page 11](page-011.png){.column-margin}
