...
description: How to blog like a life-hacker.
image: workflow.jpg 
catagories: [productivity, workflow, blogging]
---

I used to keep all my notes in MS OneNote. Before that I used some other software. 
OneNote works well on windows and after I moved to a mac I started to get more and more friction. 
When I moved to linux I ended my use of OneNote - the product had benn getting 
worse not better for many years and it was also a closed garden - I found 
I had to go to great lengths to share or get my data out.

Another of the down sides of using OneNote is how hard it is to publish anything. 
This got worse when it migrated to the cloud. 

Eventually I realized I need to move to a more flexible platform. 
However the move would only work if it would reduce the overall time and work required to do this work.
