...
{{< video width="560" height="315" src="https://www.youtube.com/embed/_d0OXm0dRZ4" title="YouTube video player" >}}
...
![mindmap](s1-mindmap.png){.column-margin}
...
![](s2-extractive-abstractive.png){.column-margin}
...
![s8-luhn-method-1958](s8-luhn-method-1958.png){.column-margin}
...
![s9-luhn-method-formula](s9-luhn-method-formula.png){.column-margin}
...
![s10-edmundson-method](s10-edmundson-method.png){.column-margin}
...
![s12-FRUMP-demo](s12-FRUMP-demo.png){.column-margin}
...
![s16-Mead-Centroid](s16-Mead-Centroid.png){.column-margin}
...
![Lexrank](s17-lexrank.png){.column-margin}
...
![lexrank rank](s18-lexrank-rank.png){.column-margin}
...
![lexrank graph](s19-lexrank-graph.png){.column-margin}
...
![seq2seq](s19-seq2seq.png){.column-margin}
---

# Evaluation

![Information Content](s22-information-content.png){.column-margin}
...
![Precision & Recall](s24-precision-recall.png){.column-margin}
...
![s24-utility](s24-utiliity.png){.column-margin}
...
![s25-pyramid](s25-pyramid.png){.column-margin}
...
![s25-rougue](s25-rougue.png){.column-margin}
