...
categories: [NLP, notes, summarization task, lecture notes, bibliography, literature review]
...
![pooled-plate-model](pooled-plate-model.png){.column-margin}
...
![unpooled-plate-model](unpooled-plate-model.png){.column-margin}
...
![partially-pooled-plate-model](partialy-pooled-plate-model.png){.column-margin}
...
![](varying-intercepts-plate-model.png){.column-margin}
...
![](varying-slopes-plate-model.png){.column-margin}
...
![varying-intercepts-and-slopes-plate-model](varying-intercepts-and-slopes-plate-model.png){.column-margin}
...
![hierarchical-intercepts-model](hierarchical-intercepts-model.png){.column-margin}
...
![correlations-among-levels-plate-model](correlations-among-levels-plate-model.png){.column-margin}
