...
1. CTR for many web based events is less than 5% but since it is **a ratio** it can take take very large values should a  conversion occur first. This will give a sequence of 100% 50% 25% 12.5% 6.25%. The 
CTR trends will eventually correct themselves as leads convert But during this time the new client is allocated a disproportionate number of leads.
...
1. How to compare different rules sets?
    ...
    - Regret - the cost of classifications.
1. How to balance exploration and exploitation?
    - introduce a parameter for exploration vs exploitation.
