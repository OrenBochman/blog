[![Inlining citations](neural-network.png)](neural-network.png "Inlining citations")
...
4.  Identify orphan citations and move them to the authorities list (e.g. related links). And while this blog post discusses wikipedia articles. This type of problems can be seen in many reference works which make terse listing of citations after an article..
...
It should also be possible to suggest citations for an article without citations. The model would be trained on a large data set built by removing inline citations and supervised based on the location.
...
@online{bochman2021,
  ...
  date = {2021-08-13},
  url = {https://orenbochman.github.io/posts/2021/2021-08-13-inlining-citations/},
  langid = {en}
}
```
...
Bochman, Oren. 2021. “Inlining Citations for Wikipedia Articles.” August 13. <https://orenbochman.github.io/posts/2021/2021-08-13-inlining-citations/>.
