...
title: command line
subtitle: command line cheat sheet macos + zsh + git
description: command line cheat sheet macos + zsh + git
keywords: [command line, productivity, macos, terminal, git]
categories: [productivity, mac]
---
