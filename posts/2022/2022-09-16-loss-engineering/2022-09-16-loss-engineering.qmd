...
description: Understanding the challenges and strategies in multi-task learning
categories: [data science]
keywords: [machine learning, ml engineering, negative transfer, multi task learning, robust regression]
---
