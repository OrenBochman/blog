...
subtitle: NLP.IL
date: 2023-02-28
categories: [nlp, nlp.il, text classification, multi-label classification, active learning, streamlit]
keywords: [NLP, text classification, multi-label classification, active learning, streamlit]
description: "A recap of the NLP.IL talk by Moran Beladev and Elina Frayerman on building a multilingual multi-label topic classification model for reviews data in Booking.com, using fine-tuning of BERT-like models, active learning for data collection, and a demo with explainability using Streamlit."
---
