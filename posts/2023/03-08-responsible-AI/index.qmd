...
description: A recap of the Microsoft Responsible AI Toolbox webinar, which introduced two new open-source tools Responsible AI Mitigations, a Python library for implementing mitigations, and Responsible AI Tracker, a JupyterLab extension for tracking and comparing mitigations and experiments in Responsible AI.
categories: [webinar, data science, tools]
keywords: [Responsible AI, Microsoft, open source, mitigations, tracking, JupyterLab, dashboard, microsoft responsible ai toolbox]
---

::: column-margin
{{< video https://www.youtube.com/watch?v=GuMhJ5i0skE title="Responsible AI Mitigations and Tracker - Microsoft Responsible AI Toolbox Webinar" >}}
:::
...
![](Screenshot%20from%202023-03-08%2019-11-39.png){.column-margin} ![](Screenshot%20from%202023-03-08%2019-11-42.png){.column-margin} ![](Screenshot%20from%202023-03-08%2019-13-00.png){.column-margin} ![](Screenshot%20from%202023-03-08%2019-14-27.png){.column-margin} ![](Screenshot%20from%202023-03-08%2019-14-32.png){.column-margin} ![](Screenshot%20from%202023-03-08%2019-16-13.png){.column-margin} ![](Screenshot%20from%202023-03-08%2019-17-28.png){.column-margin} ![](Screenshot%20from%202023-03-08%2019-18-22.png){.column-margin} ![](Screenshot%20from%202023-03-08%2019-18-46.png){.column-margin}

## Demo

![](Screenshot%20from%202023-03-08%2019-21-51.png){.column-margin}
