...
The keys to make progress in this area seem to be asking better research questions, and considering a rich variety of pre-linguistic objects incorporated into the states of the world to better simulate realistic requirements of agents. 
The problem is that many such questions are either too hard, or too vague to lead to a clear path forward. 
...
![Emergent Languages In a Nutshell](/images/in_the_nut_shell_gemeni.png)
...
The first is that sender may decide to swap the signal between states and jump closer to a homomorphic equilibrium. This can happen using epsilon greedy exploration and may be reinforced over time if the outcome is better.
...
30:48
A complex signaling system with a few persistent. A few persistent.
31:06
