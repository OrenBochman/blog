...
categories: [abm, agent based modeling, game theory, signaling games]
keywords: [bayesian agents, MESA, signaling games]
description: A quick note about Bayesian Agents and how to implement them using the MESA framework in Python.
---

## The Sherif Dilemma Game

The Sherif Dilemma is a considered a signaling game in game theory
However is is also a fairly simple example of a Bayesian game
