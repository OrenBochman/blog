...
subtitle: "Extending Sugarscape for Curriculum Learning"
categories: [sugarscape, agent based modeling, marl, sequential social dilemmas, complex signaling system]
keywords : ["sugarscape", "multi-agent simulation", "agent based modeling", "agent based social simulation", "multi-agent reinforcement learning", "sequential social dilemmas", "cooperation", "markov games", "non-cooperative games", "complex signaling system"]
description: "In this post, I explore ideas for extending the Sugarscape environment to create a richer curriculum learning environment for multi-agent reinforcement learning, with a focus on emergent properties, complex landscapes, ecological dynamics, and social interactions."
...
In this version region with sugar are created by dropping sugar on the landscape.
...
The paper [@Team2021OpenEndedLL] described a new approach to learning called Open-Ended Learning. In it an functional generated environment was described called Xland. I think
that one way to make sugarscape more more challenging is by composing more complex landscapes.
...
- We can model this using a predator-prey models
  ...
  As one is hunted e.g. stag hunt targeting deer will boost the numbers of rabbits 
