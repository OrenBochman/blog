...
[Synthesis-and-Stabilization](../../2023/06-01-synthesis-and-stabilization/index.qmd)
...
2.  Parametrizing these as different trade-offs for the algorithm
...
3.  The reward hypothesis - that all goals can be described by the maximization of the expected reward c.f. ([Silver et al. 2021](#ref-SILVER2021103535))
...
6.  The idea of doubly robust estimators for correct importance sampling of small trajectory samlples in off policy learning. This could be the cornerstone of few shot learning algorithms.
...
Hinton’s in his course and in ([Nowlan and Hinton 1992](#ref-Nowlan1992SimplifyingNN)) at [paper](https://www.cs.utoronto.ca/~hinton/absps/sunspots.pdf) describes his approach where by initilizing neural networks with zero values this in effect creates a network that that can grow in capacity as it learns. This can continue until all the weights are non-zero.
...
This idea is also of some interest to RL where different function approximation methods use neural networks to approximate value functions, V,Q or the policy pi. Model based methods also use neural networks to approximate the model of the environment which typically is a state transition function M(s'\|a, s) and a reward function R(s'\|a,s) though a four part dynamics model can also be used p(s',r\|a,s).
...
- Trust Region Policy Optimization - TRPO ([Schulman et al. 2015](#ref-Schulman2015TrustRP)) [paper](https://arxiv.org/abs/1502.05477)

OpenAI Gym tutorial [notebook](https://colab.research.google.com/drive/1PDdfwG1cZB6YXYsqkask6iDw3_XoYHTR)

([Russo et al. 2017](#ref-Russo2017ATO)) [A Tutorial on Thompson Sampling](https://arxiv.org/abs/1707.02038)

[The Development of Embodied Cognition: Six Lessons from Babies](https://cogdev.sitehost.iu.edu/labwork/6_lessons.pdf)

[The real reason for brains](https://www.ted.com/talks/daniel_wolpert_the_real_reason_for_brains/transcript?language=en)

[Evolution Strategies as a Scalable Alternative to Reinforcement Learning](https://arxiv.org/abs/1703.03864)

[The CMA Evolution Strategy: A Tutorial](https://arxiv.org/pdf/1604.00772)

[Robots that can adapt like animals](https://arxiv.org/abs/1407.3501) So here are some algorithms I read about and papers to cover.
...
## Making algorithms that can transfer to different problems

- IMPALA algorithm

- Using Impala with Pixels

- [Rainbow - Combining Improvements in Deep Reinforcement Learning](https://arxiv.org/abs/1710.02298) Combine the following DQN variants to make Rainbow variant.
...
Nowlan, S., and Geoffrey E. Hinton. 1992. “Simplifying Neural Networks by Soft Weight-Sharing.” *Neural Computation* 4: 473–93. <https://www.cs.utoronto.ca/~hinton/absps/sunspots.pdf>.
...
Silver, David, Satinder Singh, Doina Precup, and Richard S. Sutton. 2021. “Reward Is Enough.” *Artificial Intelligence* 299: 103535. https://doi.org/<https://doi.org/10.1016/j.artint.2021.103535>.
...
Bochman, Oren. 2024. “Readings in Rl.” June 18. <https://orenbochman.github.io/posts/2024/2024-06-18-readings-in-rl/>.
