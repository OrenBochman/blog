...
<!-- TODO: migrate to rl notes repo -->


A list of RL-papers and resources that I have read or plan to read.

- [x] [Synthesis-and-Stabilization](../../2023/06-01-synthesis-and-stabilization/index.qmd)
...
use neural networks to approximate value functions, V,Q or the policy pi. Model based
methods also use neural networks to approximate the model of the environment which
typically is a state transition function $M(s'|a, s)$ and a reward function $R(s'|a,s)$
