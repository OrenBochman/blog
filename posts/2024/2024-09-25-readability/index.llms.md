...
ideally we want to learn structures:

\text{paragraph} \to \cdots \to \text{top level}

and ideally we would like to learn to research
...
@online{bochman2024,
  ...
  date = {2024-09-25},
  url = {https://orenbochman.github.io/posts/2024/2024-09-25-readability/},
  langid = {en}
}
```
...
Bochman, Oren. 2024. “Fine-Tune Llm for Style and Grammar Advice.” September 25. <https://orenbochman.github.io/posts/2024/2024-09-25-readability/>.
