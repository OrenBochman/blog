...
2. we don't know thier stated position 
3. we don't know thier influence
...
5. try more sophisticated approches
...
So there is that inherent mathmatical complexity to deal with. 
If I'm not mistaken the author is bent on reporting his successes without revealing too much about how to reproduce his work. I havent reviewd the relevant papers.
...
![old-model](Screenshot from 2024-01-27 22-57-23.png)
...
![new model](Screenshot from 2024-01-27 23-09-22.png)
