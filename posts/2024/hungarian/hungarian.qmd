...
I've been learning Hungarian on Duolingo in the last year. Before that I learended in the hungarian Debreceni summer school for a two or three courses and before that the full Pimsluer course. The main problem with Duolingo is that it does not explain grammar except by example. 
...
At this point I have some issues with word order of some sentences. Which I hope to figure out. Talking with native hungarian friends is both amusing and disappointing. They could make no coherent explaintion of why the sentes follow that order.


## Alphabet

![](Hungarian_alphabet_-_Magyar_ábécé.svg.png)
![](hungarianipacons.gif)
...
### Vowel Harmony
![](Hungarian_vowel_chart.svg){.column-margin}
