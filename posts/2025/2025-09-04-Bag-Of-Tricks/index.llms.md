...
[Fire Scraper](https://firescraper.com/) Web Scraping Python  
commercial tool for extracting articles from web pages.

[Faker](https://faker.readthedocs.io/en/master/) Data Generation Python FOSS  
...
[OpenRefine](https://openrefine.org/blog/2025/06/10/OpenRefine-2025-Barcamp) FOSS  
...
[Scrapy](https://scrapy.org/) Web Scraping Python FOSS  
is an open-source and collaborative web crawling framework for Python.

[word2vec](https://code.google.com/archive/p/word2vec/) Embeddings Python FOSS  
A group of related models that are used to produce word embeddings.

[FastText](https://fasttext.cc/) Embeddings Python FOSS  
A library for efficient learning of word representations and sentence classification.

[GloVe](https://nlp.stanford.edu/projects/glove/) Embeddings Python FOSS  
A library for efficient learning of word representations and sentence classification.

[spacy](https://spacy.io/) NLP Python FOSS  
A package for NLP in Python.

[Prodi.gy](https://prodi.gy/) NLP Data Annotation Python Commercial : A modern annotation tool for creating training data for machine learning models.

[PySpark](https://spark.apache.org/docs/latest/api/python/getting_started/quickstart.html) Big Data Python FOSS  
...
[Outlines](https://dottxt-ai.github.io/outlines/latest/) LLM Structured Data  
Outlines guarantees structured outputs during generation — directly from any LLM.

[Dynamic Linear Models](https://cran.r-project.org/web/packages/dlm/index.html) Time Series R Bayesian  
...
[Stumpy](https://stumpy.readthedocs.io/en/latest/) Time Series Python  
STUMPY is a library for time series data mining, focusing on **matrix profile** algorithms.

[Pydantic](https://docs.pydantic.dev/latest/) Data Validation Python  
...
[Quarto](https://quarto.org/) Blogging Data Science FOSS  
...
[Deepchecks](https://deepchecks.com/) Model Evaluation Python FOSS  
...
Dynamic Linear Models (DLMs) R Time Series Bayesian  
...
[Talend](https://www.talend.com/) ETL Data Integration FOSS  
...
[DLT](https://github.com/delta-io/delta) ETL Data Pipelines FOSS  
...
Bochman, Oren. 2025. “AI a Bag of Tricks.” September 4. <https://orenbochman.github.io/posts/2025/2025-09-04-Bag-Of-Tricks/>.
