...
Also we can use a family of related models to learn much about the state space if we can collect data in the form of a replay buffer of past states and actions. I am referring to trifecta of HMM algorithms consiting of:
...
2. [Baum-Welch](https://en.wikipedia.org/wiki/Baum%E2%80%93Welch_algorithm) to estimate transition and emision probabilities and the 
