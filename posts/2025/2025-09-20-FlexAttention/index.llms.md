...
- I came on an early paper where there was just the one attention head and all that it did was count so that the output sequence had coverage of the input sequence. ([*Citation Needed*, n.d.](#ref-cn))
...
- **N-level features** While we said the heads should be competitive we recognize that many problems are multilevel and that we may need to build features based on features learned by other heads.
...
@online{bochman2025,
  ...
  title = {FlexAttention: {A} {Flexible} {Approach} to {Attention}
    {Mechanisms}},
  date = {2025-09-20},
  url = {https://orenbochman.github.io/posts/2025/2025-09-20-FlexAttention/},
  langid = {en}
}
```
...
Bochman, Oren. 2025. “FlexAttention: A Flexible Approach to Attention Mechanisms.” September 20. <https://orenbochman.github.io/posts/2025/2025-09-20-FlexAttention/>.
