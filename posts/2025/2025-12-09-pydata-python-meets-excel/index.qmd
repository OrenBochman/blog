...
:::: {.sl}
::: {.sl-text}
I have a PhD in Mathematics and have taught engineers, MBAs, and corporate teams. I love speaking at tech events and contributing to the community through blogs, forums, and YouTube.
:::
::: {.sl-fig}
...
:::: {.sl}
::: {.sl-text}
Excel isn't going anywhere. Business users prefer Excel for its familiarity and flexibility. They expect deliverables in Excel, even if Python is used for analysis.
:::
::: {.sl-fig}
...
:::: {.sl}
::: {.sl-text}
Pandas is a powerful library for data analytics. You can use it to analyze data and export results to Excel. But what about formatting and customization?
:::
::: {.sl-fig}
![pandas](slide09.png)
:::
...
:::: {.sl}
::: {.sl-text}
The ExcelWriter class in pandas allows for customization. You can write multiple datasets to the same sheet, format headers, and more.
:::
::: {.sl-fig}
