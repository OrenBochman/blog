...
categories: [pydata, odsc, data compression, zarr, odsc]
...
::: {.column-margin}
{{< video https://www.youtube.com/watch?v=tUvSI3EpTBQ title="Hands-on with Blosc2: Accelerating Your Python Data Workflows" >}}
:::
...
[Participants will learn to use the python-blosc2 library to compress and decompress data with various codecs and filters, optimizing for speed and ratio.]{.mark}
...
1. why blosc_2 and not say zarr or other solutions?