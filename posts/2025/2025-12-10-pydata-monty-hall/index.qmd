---
title: "Lessons in Decision Making from the Monty Hall Problem"
subtitle: "PyData Global 2025 Recap"
image: pydata_logo.png
date: 2025-12-10
categories: [data science, decision making, probability]
keywords: [Monty Hall Problem, Decision Making, Probability, Bayesian Thinking, Causal Reasoning]
---

![pydata global](pydata_logo.png){.column-margin}

::: {.column-margin}
{{<video https://www.youtube.com/watch?v=fh1Vmwy0pyM >}}
[Eyal Kazin](https://www.linkedin.com/in/eyal-kazin/) - Lessons in Decision Making from the Monty Hall Problem
:::

::: {.column-margin}
{{< video https://youtu.be/ugbWqWCcxrg >}}
Monty Hall Problem - Numberphile  with Lisa Goldberg
:::

::: {.column-margin}
{{< video https://www.youtube.com/embed/fh1Vmwy0pyM >}}
...
Kazin is an Ex-cosmologist turned data scientist with 20 years experience in solving challenging problems. Motivated by intellectual challenges, highly detail oriented and love visualizing data results to communicate insights for better decisions within organizations.

His main drive is applying scientific approaches that result in practical and clear solutions. To accomplish these, he uses whatever works, be it statistical/causal inference, machine/deep learning or optimization algorithms. Being result driven he has a passion for facilitating stakeholders to make data driven decisions by quantifying and communicating the impact of interventions to non-specialist audiences in an accessible manner.

In his free time he crafts engaging articles on applied stats in data science and machine learning: [medium](https://medium.com/@eyal-kazin).
:::
...
- [The Card Matching problem](https://en.wikipedia.org/wiki/Matching_problem) (Montmort, 1959) - What is the probability that at least one card matching its position when a deck of size N is shuffled? 
 cards, labelled 1 to N, is randomly arranged
