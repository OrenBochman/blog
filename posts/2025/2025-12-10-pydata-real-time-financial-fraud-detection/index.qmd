...
categories: [pydata global 2025]
keywords: [PyData Global 2025, financial fraud detection, machine learning, Python, real-time systems]
description: "A recap of the PyData Global 2025 talk on real-time financial fraud detection using modern Python tools and techniques."
image: pydata_logo.png
---

::: {.column-margin}
{{< video https://www.youtube.com/watch?v=nEg8T8doy64 title="Realtime Financial Fraud Detection with Modern Python" >}}
:::
