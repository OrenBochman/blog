...
categories: [pydata, ml, slm, pytorch]
keywords: [small language models, AI, Transformers, Deep Learning]
description: "A recap of Jayita Bhattacharyya's talk at PyData Global 2025 on Small Language Models (SLMs), exploring their capabilities, training techniques, and implications for AI development."
image: pydata_logo.png
---

::: {.column-margin}
{{< video https://www.youtube.com/watch?v=dFOqSFW08Qg title="How Big are SLMs" >}}
:::
