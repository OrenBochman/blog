...
date: 2025-12-12
categories: [pydata, odsc, ml, embeddings]
keywords: [embeddings, decision tree, random forest]
description: "A detailed recap of the PyData Global 2025 talk by Claudio Salvatore Arcidiacono on effectively using text embeddings in tree-based models, covering key concepts, methodologies, and practical implementation tips."
