---
title: "Streaming AI Workflows in Python"
subtitle: "Kafka Queues & Flink-Powered LLM Inference"
date: 2025-12-12
categories: [pydata, odsc, pipelines]
keywords: [Kafka, Flink, LLMs, stream processing]
description: "A detailed recap of the PyData Global 2025 talk on streaming AI workflows in Python, focusing on Kafka queues and Flink-powered LLM inference."
image: pydata_logo.png
---

::: {.column-margin}
{{< video https://www.youtube.com/watch?v=FW6AAXs4PqU title="Shekhar Prasad Rajak & Jatoth Bharath - Streaming AI Workflows in Python: Kafka Queues & Flink-Powered LLM Inference" >}}
:::
...
- Shekhar Prasad Rajak
    ...
    - 🌸 Passionate Open Source Advocate and Software Engineer at Apple. Shekhar is a seasoned open-source developer and advocate, with contributions to SymPy, NumPy, SciPy, Bundler, and as the author of daru and daru-view in the SciRuby ecosystem. A two-time GSoC alumnus (2016,17) and former SciRuby org admin, he has mentored across multiple open-source communities. He has spoken at leading conferences, including RubyConf, PyCon, ApacheCon, and Community Over Code. Currently, he is a Software Development Engineer at Apple, driving innovation in software engineering.
