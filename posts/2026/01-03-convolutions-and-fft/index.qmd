...
subtitle: "Convolutions, Fourier transforms, and the Fast Fourier Transform (FFT)"
categories: [math, probability]
keywords: [convolutions, fourier transforms, fft, probability, signal processing]
description: "Convolutions are a fundamental mathematical operation that arises in many areas of mathematics, physics, and engineering. In this post, we will explore the concept of convolutions and how they relate to Fourier transforms and the Fast Fourier Transform (FFT)."
---
...
::: {#vid-convolutions .column-margin}
...
::: {#vid-fft .column-margin}
{{< video https://www.youtube.com/watch?v=8rrHTtUzyZA width="400" height="300" title="Convolutions in Image Processing" >}}
:::

::: {#vid-fft2 .column-margin}
