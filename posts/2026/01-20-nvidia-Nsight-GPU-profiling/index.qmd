...
date: 2026-01-19
categories: [AI, agents, MLOps, meetup, GPU profiling]
keywords: [autonomous agents, AI agents, technology trends, future of AI, intelligent agents, machine learning, AI applications, AI research, context platform engineering, GPU profiling, NVIDIA Nsight, PyTorch optimization, AI infrastructure, performance engineering]
description: "In this talk, Chaim Rand revisits the NVIDIA Nsight profiling tools to augment the PyTorch Profiler, addressing critical issues in data transfer and batching for AI/ML workloads, and providing practical insights for optimizing performance in GPU-accelerated environments."
---
...
::: {.column-margin}
{{< video https://youtu.be/XoZcY_fDUKA?t=587 title="Nvidia GTC 2025 Recap + PyTorch Model Tuning +AI Systems Performance Engineering Tips" >}}
...
::: {.column-margin}
{{< video https://youtu.be/F8jJwI9xHTE?t=168 title="PyTorch Data Loader Tuning + GPU Cross-Architecture Optimizations: CUDA and AMD" >}}
...
- The long series covers the pytorch optimizer + [tensorboard](https://docs.pytorch.org/tutorials/recipes/recipes/tensorboard_with_pytorch.html) tool for visualization. It looks like tensorboard has been abandoned by google or at least deprecated in favor of other tools. Are there any other tools that one should be using today?
    ...
    - Chrome via *chrome://tracing* c.f. [How to use the Chrome UI to analyze Pytorch Profiler traces?
](https://www.youtube.com/watch?v=AhIOohJYSrw) c.f. Chrome Tracing ui: 
