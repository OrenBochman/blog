...
The two main approaches we saw were the [EM algorithm](https://en.wikipedia.org/wiki/Expectation%E2%80%93maximization_algorithm) and [Gibbs sampling](https://en.wikipedia.org/wiki/Gibbs_sampling).
...
2.  **Label switching** is a second issue can be addressed by imposing constraints on the parameters, such as ordering the means of the components or using a specific parameterization that breaks the symmetry. However, these constraints can introduce bias and may not always be appropriate for the data.
3.  The **unknown number of components** for the mixture model is often unknown.
...
@online{bochman2026,
  ...
  date = {2026-03-07},
  url = {https://orenbochman.github.io/posts/2026/03-07-mixture-problems/},
  langid = {en}
}
```
...
Bochman, Oren. 2026. “Mixture Problems.” March 7. <https://orenbochman.github.io/posts/2026/03-07-mixture-problems/>.
