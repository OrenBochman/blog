...
date: 2026-04-28
title: Kyle Stratis
subtitle: AI Agents with MCP 
categories: [odsc, ai, talk, agents, mcp]
keywords: [AI Agents, Model Context Protocol, MCP, Book Signing, lethal trifecta]
description:  "A deep dive into Kyle Stratis's talk at ODSC AI 2026 <br> on AI Agents with MCP, exploring the practical implementation and best practices for building AI agents using the Model Context Protocol."
---

## Book Author: AI Agents with MCP {#sec-book-author-ai-agents-with-mcp}
...
* **When to use a skill**
  ...
  * [Use a skill when the task is mostly prompt-based, lightweight, personal, or limited to a small team.]{.marked}
...
* **When to use an MCP server**
  ...
  * [Use an MCP server when the capability resembles an external API, needs authentication, must be distributed broadly, requires versioning, or exposes tools/data rather than just a prompt.]{.marked}
...
* **Overall takeaway**
  ...
  * [MCP is best understood as infrastructure for distributing reusable, agent-ready capabilities.]{.marked}
  * [Skills are excellent for lightweight prompt augmentation; MCP is better for robust, scalable, authenticated, and reusable agent integrations.]{.marked}
