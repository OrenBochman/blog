...
categories: [odsc, ai, talk, agents, claude]
keywords: [Claude, Anthropic, AI Agents, Financial Services, Workflow Automation]
description:  "A deep dive into Mikaela Grace and April Guo's talk at ODSC <br> AI 2026 on building Claude-based agents for financial-services industry workflows,<br> exploring best practices, examples, and hands-on practice."
---
