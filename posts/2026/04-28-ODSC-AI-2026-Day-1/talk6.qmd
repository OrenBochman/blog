...
categories: [odsc]
description:  A deep dive into Andy Petrella's talk on the operational transformation of data architecture, exploring the unification of symbolic reasoning and neural computation in a single language for AI.
---
