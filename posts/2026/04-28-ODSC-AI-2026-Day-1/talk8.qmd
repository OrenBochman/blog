...
subtitle:  using Kafka, Flink, and Apache Pinot
categories: [odsc, flink, pinot, kafka, data-engineering, ai]
keywords: [Real-Time Analytics, Event-Time Consistency, Kafka, Flink, Apache Pinot, Data Engineering, Robinhood]
description:  A deep dive into Deep Patel's talk at ODSC AI 2026 <br> on real-time event-time consistent analytics pipelines, <br> exploring the use of Kafka, Flink, and Apache Pinot for <br> low-latency, high-throughput analytics.
title-block-banner: t8_banner_flink.png
image: t8_hero_flink.png
---

## Real-Time Event-Time Consistent Analytics Pipelines using Kafka, Flink, and Apache Pinot {#sec-real-time-event-time-consistent-analytics-pipelines-using-kafka-flink-and-apache-pinot}
...
* **Why Flink**
  * [Flink was chosen for true streaming, event-time processing, state management, and exactly-once-style semantics.]{.marked}
...
* **Why Apache Pinot**
  * [Pinot is a distributed columnar Online Analytical Processing database designed for high-throughput, low-latency analytics.]{.marked}
...
* **Hybrid table strategy**
  ...
  * This enabled [Lambda-style architecture: fast approximate/fresh data first, then corrected/reconciled data later.]{.marked}
