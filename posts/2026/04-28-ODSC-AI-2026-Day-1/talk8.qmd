...
categories: [odsc, flink, pinot, kafka, data-engineering]
description:  A deep dive into Deep Patel's talk on <br> real-time event-time consistent analytics pipelines, <br> exploring the use of Kafka, Flink, and Apache Pinot for <br> low-latency, high-throughput analytics.
