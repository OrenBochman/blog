...
description:  "A deep dive into Ryan Day's talk at ODSC <br> AI 2026 on Model Context Protocol (MCP), exploring how to provide data and functionality to AI agents using Python."
---
