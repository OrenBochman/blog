...
categories: [odsc, ai, talk, mcp, python, agents]
keywords: [Model Context Protocol, FastAPI, Data Science]
description:  A deep dive into Ryan Day's talk at ODSC AI 2026 <br> on Model Context Protocol (MCP), exploring how to provide data and functionality to AI agents using Python.
---
