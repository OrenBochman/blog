...
subtitle:  Enhancing Clinical Reasoning with Knowledge Graphs, GNNs, and Agents
categories: [odsc, ai, healthcare]
keywords: [GraphRAG, Healthcare, Knowledge Graphs, GNNs, Agents]
description:  A deep dive into Giuseppe Futia's keynote on GraphRAG in healthcare,<br> exploring the integration of knowledge graphs, GNNs, and agents for clinical reasoning.
---

## GraphRAG in Healthcare: Enhancing Clinical Reasoning with Knowledge Graphs, GNNs, and Agents {#sec-graphrag-healthcare}
