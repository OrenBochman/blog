...
categories: [odsc, ai ]
keywords: [Agentic LLMs,Google DeepMind, LLM Engineering, Function Calling, Observability]
description:  A deep dive into Naman Goyal's keynote on agentic large language models,<br> exploring the challenges and strategies for building reliable and observable LLMs.
---
