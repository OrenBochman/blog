...
subtitle:  Interpretability of LLMs in Finance
categories: [odsc, ai, interpretability]
keywords: [interpretability, finance, large language models, mechanistic interpretability, sparse autoencoders, feature attribution, behavioral interpretability, surrogate models, visual explanations]
description:  A deep dive into Hariom Tatsat's keynote on interpretability of large language models in finance, exploring the challenges and strategies for ensuring reliability and safety.
---

## Beyond the black box - Interpretability of LLMs in Finance {#sec-interpretability-llms-finance}
