...
subtitle: 
categories: [odsc, ai, memory, agents]
keywords: [AI Agent Memory, Neo4j, Context Graph, Short-term Memory, Long-term Memory, Reasoning Memory]
description:  A deep dive into William Lyon's talk on the AI agent memory landscape, exploring the challenges and solutions for structured, shared, and evolving memory in production AI agents.
---

## The AI Agent Memory Landscape {#sec-ai-agent-memory-landscape}
