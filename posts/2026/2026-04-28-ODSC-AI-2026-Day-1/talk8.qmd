...
categories: [ODSC]
description:  A deep dive into Deep Patel's talk on real-time event-time consistent analytics pipelines, exploring the use of Kafka, Flink, and Apache Pinot for low-latency, high-throughput analytics.
---
