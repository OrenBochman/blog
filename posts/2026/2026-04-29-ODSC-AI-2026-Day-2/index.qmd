...
::: {.column-margin}
{{< video https://vimeo.com/1187953192 >}}
:::
...
::: {.column-margin}
{{< video https://vimeo.com/1187957189 >}}
:::
...
::: {.column-margin}
{{< video https://vimeo.com/1188033410 >}}
:::
...
* **Core idea:** [Personal AI is not just a chat interface like ChatGPT, Claude, or Gemini. It is an always-on agent that can run in the background, access tools, remember context, and take actions on the user’s behalf.]{.marked}
* **Main distinction:**
...
* **Final takeaway:** [Personal AI in 2026 means gradually offloading repetitive administrative and digital work—email triage, calendar prep, meeting prep, content drafting, newsletter creation, issue triage, and cross-tool coordination—while keeping human review for creative, strategic, and high-stakes decisions.]{.marked}
...
::: {.column-margin}
{{< video https://vimeo.com/1187957918 >}}
:::
...
* **Closing framing:**
  ...
  * AI security should follow the lifecycle: [identify, protect, detect, respond, and recover]{.marked}.
...
::: {.column-margin}
{{< video https://vimeo.com/1188040425 >}}
:::
...
<!--- [slides](https://docs.google.com/presentation/d/1O6uQKacI1H38F4oDnmjlZMnD1yLW00Q3IQQ4qc6CyPk/) -->
...
* **Final takeaway**
  ...
  * The workshop's main message is that [robust context engineering requires more than a vector database]{.marked}.
  ...
  * [The strongest pattern is not “one big agent,” but a structured system of smaller agents with clear roles, tools, routing, and observability]{.marked}.
...
::: {.column-margin}
{{< video https://vimeo.com/1189317978 >}} 
:::
...
::: {.column-margin}
{{< video https://vimeo.com/1187962061 >}}
:::
...
::: {.column-margin}
{{< video https://vimeo.com/1187963874 >}}
:::
...
::: {.column-margin}
{{< video https://vimeo.com/1188023060?fl=pl&fe=vl >}}
:::
...
* Andrew’s core claim is that [reliable data must be improved at the source, by treating data with the same seriousness, ownership, documentation, and change management as software APIs.]{.marked}
...
::: {.column-margin}
{{< video https://vimeo.com/1188024188 >}}
:::
...
::: {.column-margin}
{{< video https://vimeo.com/1188210276 >}}
:::
...
* The main takeaway is that [individuals can now build, review, ship, and maintain real software much faster and with broader scope than was previously feasible alone]{.marked}
...
::: {.column-margin}
{{< video https://vimeo.com/1189330716 >}}
:::
