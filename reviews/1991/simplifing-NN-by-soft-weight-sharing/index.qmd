...
description: "A review and study guide of the paper 'Simplifying Neural Networks by Soft Weight Sharing' by Nowlan and Hinton, which introduces a method for reducing the complexity of neural networks by modeling the distribution of weight values as a mixture of Gaussians, allowing for clustering of weights and improved generalization."
cover: cover.jpg
---
