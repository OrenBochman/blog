...
![All of Statistics in a nutshell](/images/in_the_nut_shell_gemeni.png)
...
: [Learning using data to estimate an unknown quantity]{.mark}. Refers to providing a single “best guess” of some quantity of interest (point estimation).
...
Point Estimation
: [Providing a single “best guess” of some quantity of interest]{.mark}, such as a parameter, cdf $F$, pdf $f$, regression function $r$, or a prediction.
...
*   **7 Nonparametric Estimation of a CDF and Statistical Functionals**
    ...
    *   **7.2 Statistical Functionals**
        ...
        *   The $p$th sample quantile is defined as $T(F̂_n) = F̂_n^{-1}(p)$.
