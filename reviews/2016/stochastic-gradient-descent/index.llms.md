...
- Back propagation  
  Also Backprop, the backwards pass through a neural network in which we attribute the overall output to each node and change their weights. This is the more complicated step. W(t+1) = W(T) -\eta \frac{\partial E^T }{ \partial W}
...
@online{bochman2021,
  ...
  date = {2021-08-29},
  url = {https://orenbochman.github.io/reviews/2016/stochastic-gradient-descent/},
  langid = {en}
}
```
...
Bochman, Oren. 2021. “Stochastic Gradient Descent - The Good Parts.” August 29. <https://orenbochman.github.io/reviews/2016/stochastic-gradient-descent/>.
