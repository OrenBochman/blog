...
It seems to me that a large capacity of big NLM is going to learn the semi-structured data we have in knowledge graph. There is a problem is the way we train these models today using embeddings that leaves a lot to be desired when one wants to retrieve information. The model learns linguistics, the lexicon and it can hardly tell the lexicon apart from named entities and their relations and it will learn common-sense knowledge and more specialized relations that we associate with open knowledge graph.
...
\hat R = \sum\_{i=0}^{N} \frac{1}{N}\times (NP_1 - NP_2)
...
@online{bochman2021,
  ...
  date = {2021-04-07},
  url = {https://orenbochman.github.io/reviews/2021/language-models-are-open-knowledge-graphs/},
  langid = {en}
}
```
...
Bochman, Oren. 2021. “Language Models Are Open Knowledge Graphs.” April 7. <https://orenbochman.github.io/reviews/2021/language-models-are-open-knowledge-graphs/>.
