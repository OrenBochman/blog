...
Wang, Ruida, Jipeng Zhang, Yizhen Jia, et al. 2024. *TheoremLlama: Transforming General-Purpose LLMs into Lean4 Experts*. <https://arxiv.org/abs/2407.03203>.
...
Bochman, Oren. 2025. “TheoremLlama An End-To-End Framework to Train a General-Purpose Large Language Model to Become a Lean4 Expert.” March 10. <https://orenbochman.github.io/reviews/2024/theorem-llama/>.

[^1]: Note: lean has a serious learning curve and is used in many current mathematics research projects.

[^2]: But is this sufficient to make a difference in the real world? GPT-4 isn’t expected to do well on lean….
